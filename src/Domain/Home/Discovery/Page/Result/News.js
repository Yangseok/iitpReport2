      ...
      try {
        ...
        if (se1 == 'search') {
          ...
          if (se2 == 'keyword') {
            ...
            data = await newsAPI.news('discovery',size,page,'',similarity,sort,filterObj,searchParam,etcParam);
          } else if (se2 == 'project') {
            data = await newsAPI.news('discovery',size,page,keyword,similarity,sort,filterObj,searchParam,etcParam);
          }
        }
      ...
      try {
        ...
        if (se1 == 'search') {
          ...
          if (se2 == 'keyword') {
            ...
            similarity = fileKeywordList;
            data = await newsAPI.news('discovery',excelSize,1,'',similarity,sort,filterObj,searchParam);
          } else if (se2 == 'project') {
            data = await newsAPI.news('discovery',excelSize,1,keyword,similarity,sort,filterObj,searchParam);
          }
        }} catch (e) {
