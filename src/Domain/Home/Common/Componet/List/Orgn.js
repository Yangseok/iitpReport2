                  ...
                  (subProjectList?.length > 0) 
                    ? subProjectList?.map((e) => {
                      return  <ListItem 
                        ...
                        desc={<NavLink to={`/view/projectout/${e.id}`} target='_blank' className='h-5 text-base font-bold text-color-footer'>더보기 ＋</NavLink>}
                      />;
                    })
                    : <li>
                      <p className='text-base text-color-placeholder'>데이터가 없습니다.</p>
                    ...
                    (subPatentList?.length > 0) 
                      ? subPatentList?.map((e) => {
                        return  <ListItem 
                          ...
                          desc={<NavLink to={`/view/patent/${e.id}`} target='_blank' className='h-5 text-base font-bold text-color-footer'>더보기 ＋</NavLink>}
                        />;
                      })
                      : <li>
                        <p className='text-base text-color-placeholder'>데이터가 없습니다.</p>
