...
export default function Main() {
  ...
  const onResearcherSelect = (e) => {
    const eName = e._reactName;
    if(eName === 'onClick' 
      || (eName === 'onKeyUp' && e.key === 'Enter')
          ...
          <div className='flex items-start gap-6 mt-2'>
            <div className='w-120'>
              <div className='list_style02'>
                <ul>
                  <li className='flex items-center' onClick={onResearcherSelect} onKeyUp={onResearcherSelect} tabIndex={0}>
                    <img src={img_researcher01} alt='연구자 프로필 이미지' />
                    <div>
                      <div className='flex items-center gap-2'>
                        <p className='text-base font-bold text-color-main'>장*탁</p>
                        <button type='button' className='h-5 px-1.5 rounded-sm text-xs font-medium text-color-white bg-color-light1'>연구자 보기↗</button>
                      </div>
                      <div className='text_style01'>
                        <p className='text-sm text-color-regular'>소속기관: <span className='font-medium text-color-main'>서울대학교</span></p>
                        <p className='text-sm text-color-regular'>과제: <span className='font-medium text-color-main'>43건</span></p>
                      </div>
                    </div>
                  </li>
                </ul>
